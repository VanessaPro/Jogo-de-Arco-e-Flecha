...
function showMessage(selector) {
  // lidar com todas as animações de texto, fornecendo seletor
...
function getIntersection(segment1, segment2) {
     // encontre o ponto de interseção de dois segmentos de linha e se o ponto está ou não em um dos segmentos de linha.
